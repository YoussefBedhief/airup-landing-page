...
const Navbar = () => {
  ...
  return (
    ...
    >
      <img src={Logo} alt="Watch logo" className="h-14 w-10 pt-2" />
      <div className="flex items-center gap-x-4">
        <a
          href="#first"
          className="text-white font-semibold p-4 cursor-pointer hover:text-transparent hover:bg-clip-text hover:hover:bg-gradient-to-r from-[#ff7043] to-orange-600"
        >
          Home
        </a>
        <a
